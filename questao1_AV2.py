...
#observação se a coluna de classes precisa ser renomeada para atributos numéricos
...
#Print do dataframe final e a distribuição de classes que se deve classificar
